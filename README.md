...
[wireframes]: Honey_Do/docs/wireframes
[components]: Honey_Do/docs/component-hierarchy.md
[sample-state]: Honey_Do/docs/sample-state.md
[api-endpoints]: Honey_Do/docs/api-endpoints.md
[schema]: Honey_Do/docs/schema.md
